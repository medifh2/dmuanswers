  ...
  <div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix" <?php print $attributes; ?>>
	...
	<div class="answers-widgets-wrapper">
      <div class="answers-submitted">
        ...
        <?php if (\Drupal::moduleHandler()->moduleExists('answers_userpoints')): ?>
      ...
      <div class="answers-body">
        <div class="content clearfix" <?php print $content_attributes; ?>>
          ...
          <span class="submitted-time">
            <?php print t('Posted ') . \Drupal::service("date.formatter")->formatInterval(time() - $node->created, 1) . t(' ago.'); ?>
          </span>
          <?php if (\Drupal::moduleHandler()->moduleExists('statistics')) {
            $statistics = statistics_get($node->nid);
			if ($statistics['totalcount'] > 0) {  
              print '<span class="views">';
              print \Drupal::translation()->formatPlural($statistics['totalcount'], '1 view.', '@count views.');
              print '</span>';
			}
		  }
          ?>
